...
# Apply patches
PATCHES="${BR2_EXTERNAL_BATOCERA_PATH}/board/batocera/amlogic/s905/patches/u-boot-2025.04/*.patch"
...
./gxlimg/gxlimg -t bl3x -c u-boot-2025.04/u-boot.bin "${EXTRACT_DIR}/bl33.enc"
./gxlimg/gxlimg \
    -t fip \
