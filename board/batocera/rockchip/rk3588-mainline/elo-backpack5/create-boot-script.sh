...
cp "${BINARIES_DIR}/rk3588s-elo-backpack5.dtb"              "${BATOCERA_BINARIES_DIR}/boot/boot/"     || exit 1
cp "${BINARIES_DIR}/rk3588s-elo-backpack5-evt.dtb"          "${BATOCERA_BINARIES_DIR}/boot/boot/"     || exit 1
